    ...
    <div className="min-h-screen bg-[#F8F9FB]">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-10">
            <h1 className="text-4xl font-bold text-indigo-950">Post a New Role</h1>
            <p className="text-neutral-500 mt-2">Reach the most qualified executive talent in the industry.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <Card className="border-none bg-white rounded-[32px] p-10 shadow-sm space-y-8">
              ...
              <div className="flex justify-end gap-4 pt-4">
                ...
                <Button type="submit" className="bg-indigo-600 hover:bg-indigo-700 rounded-2xl h-14 px-12 text-sm font-bold shadow-lg shadow-indigo-100" disabled={loading}>
